  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col justify-between shrink-0 hidden md:flex">
      ...
      <div className="p-5 border-b border-slate-800 flex items-center space-x-3">
        <div className="h-9 w-9 rounded-xl bg-blue-600 flex items-center justify-center text-white font-bold shadow-md shadow-blue-600/30">
          <IconShieldCheck className="w-5 h-5" />
        </div>
        <div>
          <div className="font-black text-sm text-white tracking-tight">Aura CRM</div>
          <div className="text-[10px] text-slate-400 font-medium">Admissions Suite</div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-800 text-xs text-slate-400">
        <div className="flex items-center space-x-2">
          ...
          <span className="font-semibold text-slate-300 text-[11px]">System Online • v3.2</span>
        </div>
      </div>
